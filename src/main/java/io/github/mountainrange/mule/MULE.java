...
public class MULE extends Application {
	...
	public static final String PUB_SCENE = "storeMenu";
	public static final String PUB_SCENE_FXML = "/fxml/storeMenu.fxml";
	public static final String LAND_OFFICE_SCENE = "storeMenu";
	public static final String LAND_OFFICE_SCENE_FXML = "/fxml/storeMenu.fxml";
	public static final String ASSAY_OFFICE_SCENE = "storeMenu";
	public static final String ASSAY_OFFICE_SCENE_FXML = "/fxml/storeMenu.fxml";
